...
class AJProgressView: UIView {
    ...
    public var imgLogo: UIImage = UIImage(named:"ARQuest")!
   
    // Pass your color here which will be used as layer color
    public var firstColor: UIColor? = #colorLiteral(red: 0.3411764801, green: 0.6235294342, blue: 0.1686274558, alpha: 1)
